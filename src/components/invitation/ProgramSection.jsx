      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        <div className="flex flex-col items-center">
          ...
          <div className="block md:hidden w-full">
            <div className={`relative py-5 transition-all duration-1000 ${
                ...
                >
                  ...
                  >
                    <div className="flex items-center justify-between mb-2">
                      <span className="font-elegant text-xl text-primary-dark">{event.time}</span>
                      <span className={`text-xs rounded-full px-3 py-1 ${
                        activeEvent === event.time
                          ? "bg-accent/10 text-accent"
                          : "bg-primary/5 text-primary/70"
                      }`}>
                        {index === 0 ? "Début" : index === invitationInfo.schedule.length - 1 ? "Fin" : `Étape ${index + 1}`}
                      </span>
                    </div>
            ...
            <div className={`relative transition-all duration-1000 ${
              ...
              <div className="flex justify-between relative">
                {invitationInfo.schedule.map((event, index) => (
                  <div
                    key={event.time}
                    className={`w-1/${invitationInfo.schedule.length} px-2 transition-all duration-500 ${
                  ...
                  >
                    ...
                    <div 
                      ...
                      onClick={() => setActiveEvent(event.time)}
                    >
                      <span className={`text-xs rounded-full px-3 py-1 mb-3 inline-block ${
                        activeEvent === event.time
                          ? "bg-accent/10 text-accent" 
                          : "bg-primary/5 text-primary/70"
                      }`}>
            ...
            <div className="p-6 rounded-2xl bg-gradient-to-br from-white/95 to-white/80 shadow-elegant backdrop-blur-sm border border-white/30 transform transition-all duration-500 hover:shadow-lg relative overflow-hidden">
              ...
              <div className="relative">
                ...
                <p className="text-primary-dark font-elegant text-xl italic leading-relaxed">
                  Nous vous invitons à respecter les horaires pour que cette journée 
                  soit aussi parfaite pour vous que pour nous.
                </p>
